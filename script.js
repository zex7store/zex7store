...
const PRODUCTS = {
  ...
  freefire: [
    ...
    { id:"ffweekly", name:"عضوية اسبوعية فري فاير", price:600, img:"images/oeekly.png", desc:"شحن عن طريق ايدي", need:"id" },
  ...
  // ✅✅✅ Spotify مصحّح (كان ناقص قوس/فاصلة)
  spotify: [
    {
      id: "spotify_individual",
      name: "Spotify Premium فردي (شهر)",
      price: 1500,
      img: "images/spotify1.png",
      desc: "حساب سبوتيفاي بريميوم شخصي لمدة شهر"
    },
    {
      id: "spotify_duo",
      name: "Spotify Premium ثنائي (شهر)",
      price: 1900,
      img: "images/spotify2.png",
      desc: "اشتراك سبوتيفاي بريميوم ثنائي لمدة شهر"
    },
    {
      id: "spotify_family",
      name: "Spotify Premium عائلي (شهر)",
      price: 2400,
      img: "images/spotify3.png",
      desc: "اشتراك سبوتيفاي بريميوم عائلي لمدة شهر"
    }
  ],
  ...
  youtube: [
    { id:"yt1", name:"حساب يوتيوب بريميوم شخصي لمدة شهر", price:1800, img:"images/youtubep.png" },
  ],
